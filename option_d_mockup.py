#!/usr/bin/env python3
# option_d_mockup.py - Dashboard Integration with Sparklines
# -----------------------------------------------------------
# Option D: Fully-integrated dashboard header with sparklines for key indicators
...
# Create a trend chart with colored zones
...
def create_sparkline(trend_type='up', width=100, height=40, color=None):
    ...
    fig = go.Figure(
        go.Scatter(
            ...
            fill='tozeroy',
            fillcolor=f"rgba({color[1:3]}, {color[3:5]}, {color[5:7]}, 0.1)",
            hoverinfo='none'
        )
    )
...
app.layout = html.Div([
    html.Div([
        # Option D: Dashboard integrated header with T2D Pulse and key indicators
        html.Div([
                ...
                dbc.CardBody([
                    html.Div([
                        ...
                        html.Div([
                            ...
                            create_pulse_glow_circle(55.7, size=200),  # Authentic score
                        ...
                        html.Div([
                            ...
                            html.Div([
                                ...
                                html.Div([
                                    ...
                                    create_indicator_card("10Y Treasury", "4.68%", "0.03%", "down")
                                ], style={
                                    'display': 'flex',
...
if __name__ == '__main__':
    app.run_server(debug=True, host='0.0.0.0', port=5053)
