...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            # Hidden div for key indicators (now in collapsible section)
            html.Div(id="indicators-hidden", style={"display": "none"}),
...
def create_sector_summary(sector_scores):
    ...
    top_sectors = html.Div([
        html.H4("Strongest Sectors", className="summary-title", 
               style={"marginTop": "0", "marginBottom": "8px", "color": "#2c3e50", 
                     "fontWeight": "600", "fontSize": "15px", "textTransform": "uppercase", 
                     "letterSpacing": "0.5px"}),
        html.Div([
            html.Div([
...
# Update all indicator trends (for collapsible Key Indicators section)
@app.callback(
    [
     # Remove old indicators from left sidebar
     # (replaced by collapsible Key Indicators section now)
