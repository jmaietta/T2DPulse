...
market_heuristics = {
    ...
    "inflation": [
        ...
        },
        {
            ...
            "condition": lambda data: data['value'].iloc[-1] < data['value'].iloc[-2] and (data['value'].iloc[-2] - data['value'].iloc[-1]) > 0.3,
        },
    ],
    "vix": [
        {
    ...
    "pce": [
        ...
        {
            "trigger": "Retail Sales ↓ > -1% MoM",
            "market_response": "Demand slowdown fears",
            "effect": "negative",
            "effect_text": "Headwind for consumer-facing tech",
            "rationale": "Signals potential earnings softness",
            "confidence": "Medium",
            "condition": lambda data: False,  # This would require retail sales data
        },
        {
            "trigger": "Conference Board Confidence < 80",
            "market_response": "Consumer risk aversion",
            "effect": "negative",
            "effect_text": "B2C software demand weakens",
            "rationale": "Lower discretionary spend",
            "confidence": "Low-Medium",
            "condition": lambda data: False,  # This would require consumer confidence data
        },
    ]
}