...
TICKERS = [
    ("APP",   "AdTech"), ("APPS",  "AdTech"), ("CRTO",  "AdTech"), ("DV",    "AdTech"),
    ("GOOGL", "AdTech"), ("META",  "AdTech"), ("MGNI",  "AdTech"), ("PUBM",  "AdTech"),
    ("TTD",   "AdTech"),

    ("ACN",   "IT Services Legacy Tech"), ("CTSH",  "IT Services Legacy Tech"),
    ("DXC",   "IT Services Legacy Tech"), ("HPQ",   "IT Services Legacy Tech"),
    ("IBM",   "IT Services Legacy Tech"), ("INFY",  "IT Services Legacy Tech"),
    ("PLTR",  "IT Services Legacy Tech"), ("WIT",   "IT Services Legacy Tech"),

    ("AMAT",  "Semiconductors"), ("AMD",   "Semiconductors"), ("ARM",   "Semiconductors"),
    ("AVGO",  "Semiconductors"), ("INTC",  "Semiconductors"), ("NVDA",  "Semiconductors"),
    ("QCOM",  "Semiconductors"), ("TSM",   "Semiconductors"),

    ("AMZN",  "Cloud Infrastructure"), ("CRM",   "Cloud Infrastructure"),
    ("CSCO",  "Cloud Infrastructure"), ("GOOGL", "Cloud Infrastructure"),
    ("MSFT",  "Cloud Infrastructure"), ("NET",   "Cloud Infrastructure"),
    ("ORCL",  "Cloud Infrastructure"), ("SNOW",  "Cloud Infrastructure"),

    ("AAPL",  "Hardware Devices"), ("DELL",  "Hardware Devices"),
    ("HPQ",   "Hardware Devices"), ("LOGI",  "Hardware Devices"),
    ("PSTG",  "Hardware Devices"), ("SMCI",  "Hardware Devices"),
    ...
    ("DDOG",  "Dev Tools Analytics"), ("ESTC",  "Dev Tools Analytics"),
